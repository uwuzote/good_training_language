...
test_fasm() {
    cc -c -o ./сборка/тесты/foreign.o ./тесты/foreign.c
    ar rcs ./сборка/тесты/libforeign.a ./сборка/тесты/foreign.o
    ...
    ./сборка/хуяк комп -вывод ./сборка/тесты/тест-внеш       ./тесты/тест-внеш.хуя       -Б ./сборка/тесты
    ...
    ./сборка/тесты/тест-внеш                 > ./сборка/тесты/тест-внеш.хуя.вывод.фазм       && diff -u ./тесты/тест-внеш.хуя.вывод       ./сборка/тесты/тест-внеш.хуя.вывод.фазм
}
